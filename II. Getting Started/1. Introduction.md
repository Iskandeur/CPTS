...
A good tester can work with a client to 
* identify risks to their organization, 
* provide information on how to reproduce these risks, 
* and guidance on either mitigating or remediating the issues identified during testing.
...
Goal of this module: Get started in Infosec.
