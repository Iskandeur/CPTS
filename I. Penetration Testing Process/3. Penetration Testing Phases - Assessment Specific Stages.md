...
Pour tester si les technos contre marchent(EDR peut détecter par ex)
...
Once paths found, priotitize.we can jump to the step where we use these to access the other systems
