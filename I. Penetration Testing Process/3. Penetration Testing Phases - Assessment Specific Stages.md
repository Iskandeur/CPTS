...
*See the dedicated note for details on the pre-engagement process, including scoping questionnaires, NDAs, RoE, etc.*
...
Test on a mirror environment of our own.

If any doubt on the safety of an exploitation, always ask the client.
If they say to stop, mention the vulnerability in the report as an issue to address.
...
| :------------------- | :-------------------- | :-------------------- |
| Evasive Testing      | Information Gathering | Pillaging             |
| Vulnerability Assessment | Privilege Escalation  | Persistence           |
| Data Exfiltration    |                       |                       |
...
For us, we can study how and why the client detected us and work on improving our evasion skills. Perhaps we did not thoroughly test a payload, or we got careless and ran a command such as `net user` or `

### ~~Pillaging~~ -> [[Pillaging]]

*Pillaging is primarily a [[Post-Exploitation]] activity focused on collecting sensitive data from a compromised host. See [[Pillaging]] note for details.*